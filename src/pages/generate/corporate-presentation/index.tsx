...
const GenerateCompanyOverview: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Generate Corporate Presentation</title>
      </Head>
      <DashboardHeader />
      <GeneratePresentation presentationType="company_overview" />
    </>
  );
};

export default GenerateCompanyOverview;
