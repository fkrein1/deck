...
const GenerateMarketResearch: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Generate Market Research</title>
      </Head>
      <DashboardHeader />
      <GeneratePresentation presentationType="market_research" />
    </>
  );
};

export default GenerateMarketResearch;
