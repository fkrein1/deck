...
const server = z.object({
  ...
  STRIPE_EUROPE_MONTHLY_SUBSCRIPTION_PRICE_ID: z.string(),
  STRIPE_EUROPE_YEARLY_SUBSCRIPTION_PRICE_ID: z.string(),
...
const processEnv = {
  ...
  STRIPE_EUROPE_MONTHLY_SUBSCRIPTION_PRICE_ID:
    process.env.STRIPE_EUROPE_MONTHLY_SUBSCRIPTION_PRICE_ID,
  STRIPE_EUROPE_YEARLY_SUBSCRIPTION_PRICE_ID:
    process.env.STRIPE_EUROPE_YEARLY_SUBSCRIPTION_PRICE_ID,
  CLOUDFLARE_ENDPOINT: process.env.CLOUDFLARE_ENDPOINT,
  CLOUDFLARE_ACESS_KEY_ID: process.env.CLOUDFLARE_ACESS_KEY_ID,
  CLOUDFLARE_SECRET_ACESS_KEY: process.env.CLOUDFLARE_SECRET_ACESS_KEY,
  CLOUDFLARE_PUBLIC_BUCKET_URL: process.env.CLOUDFLARE_PUBLIC_BUCKET_URL,
};
